...
If you know how to create a new tracker file or edit an existing tracker file to suit your needs, submit a Pull Request changing the [`trackers/`](https://github.com/trackerone/autodl-irssi/tree/master/trackers) directory in this repository. If you need it created, [submit an issue](https://github.com/trackerone/autodl-irssi/issues) here or come to the IRC channel in the footer with the following information:
