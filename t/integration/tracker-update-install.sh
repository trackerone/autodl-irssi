...
assert_count 'TRACKERUPDATE:VERSION:291.0' "$window_log" 1
assert_count 'TRACKERUPDATE:ASSET:autodl-trackers-v291.0.zip' "$window_log" 1
...
printf '%s\n' 'Offline tracker update characterization passed: replaced 1, removed 1, added 1, reloaded 2.'
